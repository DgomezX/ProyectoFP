...
--
-- Servidor: localhost
-- Tiempo de generación: 29-03-2018 a las 19:40:52
...
--
-- Base de datos: `2017p_danielgomez`
--
...
INSERT INTO `datos_usuarios` (`id`, `id_user`, `edad`, `estatura`, `peso`, `calorias`, `proteinas`, `hidratos`, `grasas`) VALUES
(1, 1, 25, 177, '85.0', 2500, '190.00', '150.00', '412.00'),
(2, 3, 42, 173, '62.0', 2186, '111.60', '325.60', '109.30'),
(3, 5, 40, 160, '60.0', 2563, '132.00', '380.60', '128.15'),
(4, 4, 35, 176, '80.0', 2859, '144.00', '427.80', '142.95'),
(5, 6, 50, 100, '100.0', 2510, '200.00', '302.00', '125.50'),
(6, 7, 55, 55, '55.0', 1332, '110.00', '156.40', '66.60');
...
INSERT INTO `dietas` (`id`, `nombre`, `id_usr`) VALUES
(1, 'Dieta de prueba', 1),
(2, 'Dieta de verano', 1),
(3, 'Dieta para testing', 3),
(4, 'Adelgaza', 6),
(5, 'a1', 5),
(6, 'Aze', 6),
(7, 'asdfafsd', 4);
...
CREATE TABLE IF NOT EXISTS `dietas_rel_alimentos` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `dietas_rel_alimentos`
--

INSERT INTO `dietas_rel_alimentos` (`id`, `id_diet`, `id_alim`, `id_comida`, `cantidad`) VALUES
(1, 1, 3, 1, 250),
(2, 1, 16, 1, 6),
(3, 1, 23, 2, 150),
(4, 1, 12, 2, 60),
