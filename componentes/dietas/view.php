                    ...
                    <div class="col-12">
                        <table>
                            ...
                            foreach($dietas as $dieta){
                                ...
                                echo "<td><a href='index.php?option=dietaAmpliada&id_dieta=".$dieta['id']."'><i class=\"fas fa-eye\"></i></a><a href='index.php?option=editorDietas&id_dieta=".$dieta['id']."'><i class=\"far fa-edit\"></i></a><a href='index.php?option=dietas&dieta_idBorra=".$dieta['id']."'><i class=\"fas fa-trash-alt\"></i></a></td>";
                                echo "<tr>";
                            }?>
                            </tbody>
                        </table>
